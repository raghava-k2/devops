            ...
            <div className="p-col-12 cac-form-container">
                {formIndex === 0 && <><div className="p-card cac-card">
                    ...
                    <div className="description col-10 mt-8">
                        <p>
                            Artifact Registry enables to centrally store artifacts and build dependencies as part of an integrated Google Cloud experience.
                            Artifact Registry provides a single location for storing and managing the packages and Docker container images.
                        </p>
                    </div>
                </>
                }
