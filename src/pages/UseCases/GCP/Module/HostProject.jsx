            ...
            <div className="p-col-12 cac-form-container">
                {formIndex === 0 && <><div className="p-card cac-card">
                    ...
                    <div className="description col-10 mt-8">
                        <p>
                        The host project is the Google Cloud project used to create the Workspace. The name of the Workspace is set to the name of host project. This isn't configurable.
                        <br/>The host project for a Workspace stores all of the configuration content for dashboards, alerting policies, uptime checks, notification channels, and group definitions that you configure. 
                        If you delete the host project, you also delete the Workspace.
                        </p>
                    </div>
                </>
                }
