        ...
        fields: [
            {
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        helpMessage: (
                            <span className="span_hint_details">
                                The resource location for the job trigger.
                            </span>
                        ),
                        uniqueKey: uuidv4(),
                        validators: [
...

                    {
                        ...
                        label: 'Output Dataset ID',
                        component: 'InputText',
                        type: 'text',
                        helpMessage: (
                            <span className="span_hint_details">
                                	Dataset ID of the output table.
...

                    {
                        ...
                        helpMessage: (
                            <span className="span_hint_details">
                                The Cloud Storage url of the file(s) to scan, in the format- gs://[bucket]/[path][/path]
