    ...
    return (
      <>
        <div>
          ...
          <div class="clearfix">
            <div class="box3"></div>
            <div> <h4 class="box1">S3 Bucket Creation</h4> </div>
              ...
              <Card style={{ padding: '10px', margin: '10px', width: 'auto', boxShadow: "0 8px 12px 0 rgba(0,0,0,0.2)" }}>
                ...
                <Form.Group>
                  <div className="row mt-2">
                    ...
                    <div className="col-6 col-6-xsmall">
                      <OverlayTrigger overlay={<Tooltip id="bucket_name">Bucket Name</Tooltip>} placement="left">
                        <span>
                          <Form.Control
                            type="text"
                    ...
                    <span className="span_hint_details">Bucket name must be unique and must not contain spaces or uppercase letters.
                    <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucketnamingrules.html" target="_blank"  icon="pi-external-link">See rules for bucket naming</a> </span>
      ...
      <p>
        This module will create one S3 bucket in the user specified region.
