...
export default function FlowlogNs3() {
  // Account details
  ...
  const [new_s3_bucket, setnew_s3_bucket] = useState("");
      ...
      <>
        <div>
          <div class="clearfix">
            ...
            <div>
              {" "}
              <h4 class="box1">VPC Flow log with (new) S3 Bucket</h4>{" "}
            </div>
                  ...
                  <Form.Group>
                    <div className="row mt-2">
                      <div className="col-6 col-6-xsmall">
                        <OverlayTrigger
                          overlay={
                            <Tooltip id="new_s3_bucket">S3 Bucket Name</Tooltip>
                          }
                          placement="left"
                        >
                          <span>
                            <Form.Control
                              type="text"
                              onChange={(e) => setnew_s3_bucket(e.target.value)}
                              name="new_s3_bucket "
                              id="new_s3_bucket "
                              value={new_s3_bucket}
        ...
        <div className="description col-10 mt-8">
          <p> This module will create VPC Flow log of the chosen VPC.
            It will also create one S3 Bucket to publish the flow log data.
