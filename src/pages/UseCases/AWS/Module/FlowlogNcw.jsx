...
export default function FlowlogNcw() {
  // Account details
  ...
  const [loggroup_name, setloggroup_name] = useState("");
  const [iam_role, setiam_role] = useState("");
  const [iam_policy, setiam_policy] = useState("");
      ...
      <>
        <div>
          <div class="clearfix">
            ...
            <div>
              {" "}
              <h4 class="box1">VPC Flow log with (new) CloudWatch logs</h4>{" "}
            </div>
                  ...
                  <Form.Group>
                    <div className="row mt-2">
                      <div className="col-6 col-6-xsmall">
                        <OverlayTrigger
                          overlay={
                            <Tooltip id="loggroup_name">Log Group Name</Tooltip>
                          }
                          placement="left"
                        >
                          <span>
                            <Form.Control
                              type="text"
                              onChange={(e) => setloggroup_name(e.target.value)}
                              name="loggroup_name "
                              id="loggroup_name "
                              value={loggroup_name}
                      ...
                      <div className="col-6 col-6-xsmall">
                        <OverlayTrigger
                          overlay={
                            <Tooltip id="iam_role">IAM Role</Tooltip>
                          }
                          placement="right"
                        >
                          <span>
                            <Form.Control
                              type="text"
                              onChange={(e) => setiam_role(e.target.value)}
                              name="iam_role "
                              id="iam_role "
                              value={iam_role}
                  ...
                  <Form.Group>
                    <div className="row mt-2">
                      <div className="col-6 col-6-xsmall">
                        <OverlayTrigger
                          overlay={
                            <Tooltip id="iam_policy">IAM Policy</Tooltip>
                          }
                          placement="left"
                        >
                          <span>
                            <Form.Control
                              type="text"
                              onChange={(e) => setiam_policy(e.target.value)}
                              name="iam_policy "
                              id="iam_policy "
                              value={iam_policy}
                              placeholder="IAM Policy"
                              required=""
                            />
                          </span>
                        </OverlayTrigger>
        ...
        <div className="description col-10 mt-8">
          <p>This module will create VPC Flow log of the specified VPC.
            It will also create one IAM Role, one IAM Policy & one Log Group,
            It will also publish the log data in CloudWatch Log Groups.
