...
const { ip } = settings;
export default function EbsVolumeCreation() {
  // Account details
      ...
      <>
        <div>
          <div class="clearfix">
            ...
            <div>
              {" "}
              <h4 class="box1">EBS Volume Creation</h4>{" "}
            </div>
            ...
            <div>
              <Form className="main-form ">
                ...
                >
                  ...
                  <h6>EBS Volume Details:</h6>
                  <Form.Group>
                    <div className="row mt-2">
                      <div className="col-6 col-6-xsmall">
                        <OverlayTrigger
                          overlay={<Tooltip id="type">Volume Type</Tooltip>}
                          placement="left"
                        >
                          <span>
                            <Form.Control
                      ...
                      <div className="col-6 col-6-xsmall">
                        <OverlayTrigger
                          overlay={<Tooltip id="size">Size</Tooltip>}
                          placement="right"
                        >
                          <span>
                            <Form.Control
                  ...
                  <Form.Group>
                    <div className="row mt-2">
                      <div className="col-6 col-6-xsmall">
                        ...
                        <span className="span_hint_details">
                          The Availability Zone to create the EBS
                          volume. The volume will be available to instances in
        ...
        <div className="description col-10 mt-8">
          <p>
             ...
             This module will create one EBS Volume with user specified
            volume type and size in specified availability zone.
          </p>
        </div>
      </>
    );
