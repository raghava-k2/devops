...
export default function Flowlogs3() {
  // Account details
      ...
      <>
        <div>
          <div class="clearfix">
            ...
            <div>
              {" "}
              <h4 class="box1">VPC Flow log with (existing) S3 Bucket</h4>{" "}
            </div>
                  ...
                  <Form.Group>
                    <div className="row mt-2">
                      <div className="col-6 col-6-xsmall">
                        <OverlayTrigger
                          overlay={
                            <Tooltip id="new_s3_bucket">S3 Bucket arn</Tooltip>
                          }
                          placement="left"
                        >
                          <span>
        ...
        <div className="description col-10 mt-8">
          <p> This module will create VPC Flow log of the chosen VPC.
            It will also publish the log data in the exisiting S3 Bucket.
