...
export default function Ec2WithAlbNlb() {
          ...
          fields: [
            {
              ...
              component: "Dropdown",
              options: dropDownOptions[STANDARD_CONTROL_CATEGORIES.LOADBALANCER_TYPE] || [],
              optionLabel: "name",
              optionValue: "value",
              filter: true,
              showClear: true,
            ...
            },
            {
              ...
              label: "Protocol",
              component: "Dropdown",
              options: dropDownOptions[STANDARD_CONTROL_CATEGORIES.PROTOCOL] || [],
              optionLabel: "name",
              optionValue: "value",
              filter: true,
              showClear: true,
          ...
          <div className="p-col-12">
            <div className="p-grid p-nogutter p-align-center cac-header-container">
              <div className="p-col-10 cac-header-title">
                <h4>EC2 Instance Creation with (ALB or NLB)</h4>
              </div>
