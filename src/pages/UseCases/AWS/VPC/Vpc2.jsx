    ...
    return (
      <>
        <div>
          ...
          <div class="clearfix">
            <div class="box3"></div>
            <div> <h4 class="box1">VPC With NAT Gateway</h4> </div>
              ...
              <Card style={{ padding: '10px', margin: '10px', width: 'auto', boxShadow: "0 8px 12px 0 rgba(0,0,0,0.2)" }}>
                ...
                <Form.Group>
                  <div className="row mt-2">
                    ...
                    <div className="col-6 col-6-xsmall">
                      <OverlayTrigger overlay={<Tooltip id="dynamodb_name">CIDR Block</Tooltip>} placement="left">
                        <span>
                          <Form.Control
                            type="text"
                ...
                <Form.Group>
                  <div className="row mt-2">
                    <div className="col-6 col-6-xsmall">
                      <OverlayTrigger overlay={<Tooltip id="dynamodb_name">Public Subnet CIDR Block</Tooltip>} placement="left">
                        <span>
                          <Chips
                            type="text"
                    ...
                    <div className="col-6 col-6-xsmall">
                      <OverlayTrigger overlay={<Tooltip id="dynamodb_name">Private Subnet CIDR Block</Tooltip>} placement="right">
                        <span>
                          <Chips
                            type="text"
                ...
                <Form.Group>
                  <div className="row mt-2">
                    ...
                    <div className="col-6 col-6-xsmall">
                      <OverlayTrigger overlay={<Tooltip id="dynamodb_name">Availability Zone</Tooltip>} placement="left">
                        <span>
                          <Chips
                            type="text"
                ...
                <h6>Elastic IP</h6>
                  ...
                  <div className="row mt-2">
                    ...
                    <div className="col-6 col-6-xsmall">
                      <OverlayTrigger overlay={<Tooltip id="dynamodb_name">EIP Count</Tooltip>} placement="right">
                        <span>
                          <Form.Control
                            type="number"
