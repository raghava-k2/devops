...
const [accountId, setaccountId] = useState(null);
  ...
  const [wlm_server_image , setwlm_server_image ] = useState("");
  ...
  const configList = {
    ...
    "usecaseName":"container2",
    "parameter":{
    "aws_region": aws_region,
    "aws_access_key": aws_access_key,
    "aws_secret_key": aws_secret_key,
    "wlm_server_image": wlm_server_image ,
  ...
  const configList1 = {
    ...
    "WLM Server Image": wlm_server_image ,
   };
...
const setformIndex = (e) => {
  ...
  if (formState === 0) {
    return (
      ...
      <div class="clearfix">
          <div class="box3"></div>
         <div> <h4 class="box1">Container - ECS Cluster, Docker Image</h4> </div>
          <Header1 />
        </div>
        <hr
          style={{
        ...
        />
        <h4 className="text-center">ECS Cluster, WLM</h4>
        <hr
          style={{
        ...
        />
            ...
            <h6>Docker Images Details</h6>
              <Form.Group>
                ...
                <div className="col-6 col-6-xsmall">
                <OverlayTrigger overlay={<Tooltip id="dynamodb_name">Docker Image Image</Tooltip>}placement="left">
                        <span>
                    <Form.Control
                      type="text"
                      onChange={(e) => setwlm_server_image (e.target.value)}
                      name="wlm_server_image "
                      id="wlm_server_image "
                      value={wlm_server_image }
      ...
      <p> This usecase will create one ECS-EC2 Linux cluster with one ECS-optimized EC2.
        It will also create one ECS task definition which consists one WLM tomcat Container definitions with respective IAM roles and CloudWatch log-groups.
