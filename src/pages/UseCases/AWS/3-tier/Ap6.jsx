...
export default function Ap6() {
  ...
  const configList1 = {
    ...
    "Application Subnet ID": private_subnet_id,
    "DB Subnet ID": db_subnet_id,
    "Webserver AMI": web_ami,
    "Webserver Instance Type": webserver_instance_type,
    "Appserver AMI": app_ami,
...
<div class="clearfix">
        <div class="box3"></div>
         <div> <h4 class="box1">IIS 3-Tier Web Application - RDS (MySQL)</h4> </div>
          <Header1 />
        </div>
          <hr
            style={{
                ...
                <Card style={{ border: 'none' }}>
                  ...
                  <Form.Control
                    ...
                    <Form.Group>
                      <div className="row mt-2">
                        <div className="col-6 col-6-xsmall">
                        <OverlayTrigger overlay={<Tooltip id="aws_region" >Application Subnet ID</Tooltip> } placement="left">
                  <span>
                  <Form.Control
                            type="text"
                            ...
                            placeholder="Application Subnet ID"
                            required=""
                          />
                    </span></OverlayTrigger>
                  ...
                  <Form.Control
                        ...
                        <div className="col-6 col-6-xsmall">
                        <OverlayTrigger overlay={<Tooltip id="aws_region" >Instance Type</Tooltip> } placement="right">
                  <span>
                  <Form.Control
                            type="text"
        ...
        />
                  ...
                  <Form.Control
                            ...
                            name="mysql_family" id="mysql_family"
                            value={mysql_family} placeholder="Mysql Family"
                            required=""
                          />
                    </span></OverlayTrigger>
                    ...
                    <Form.Group>
                      <div className="row mt-2">
                        <div className="col-6 col-6-xsmall">
                        <OverlayTrigger overlay={<Tooltip id="aws_region" >Engine</Tooltip> } placement="left">
                  <span>
                  <Form.Control
                            type="text"
                  ...
                  <Form.Control
                    ...
                    <Form.Group>
                      <div className="row mt-2">
                      <div className="col-6 col-6-xsmall">
                      <OverlayTrigger overlay={<Tooltip id="aws_region" >Major Engine Version</Tooltip> } placement="left">
                  <span>
                  <Form.Control
                            type="text"
        ...
        <div className="description col-10 mt-8">
          <p>This Blueprint automates the provision of 3 tier Architecture in existing subnets using IIS webserver and RDS MySQL Database.
            <br />&#10148; IIS Web instance provisioned in existing Public Subnet (connected to Internet).
