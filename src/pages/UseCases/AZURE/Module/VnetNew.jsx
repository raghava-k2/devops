...
export default function VnetNew() {
  ...
  const [subnet_names, setsubnet_names] = useState([]);
  const [subnet_prefixes, setsubnet_prefixes] = useState([]);
      ...
      <>
        <div>
          <div class="clearfix">
            ...
            <div>
              {" "}
              <h4 class="box1">Module - Vnet Creation</h4>{" "}
            </div>
            <Header1 />
          </div>
          <hr
                  ...
                  <Form.Group>
                    <div className="row mt-2">
                      <div className="col-6 col-6-xsmall">
                        <OverlayTrigger
                          overlay={
                            <Tooltip id="subnet_names">Subnet Names</Tooltip>
                          }
                          placement="left"
                        >
                          <span>
                            <Chips
                              type="text"
                              onChange={(e) => setsubnet_names(e.value)}
                              name="subnet_names "
                              id="subnet_names "
                              value={subnet_names}
                              placeholder="Subnet Names"
                              required=""
                              separator=","
                              allowDuplicate={false}
                            ></Chips>
                      ...
                      <div className="col-6 col-6-xsmall">
                        ...
                        >
                          <span>
                            <Chips
                              type="text"
                              onChange={(e) => setsubnet_prefixes(e.value)}
                              name="subnet_prefixes "
                              id="subnet_prefixes "
                              value={subnet_prefixes}
                              placeholder="Subnet Prefixes"
                              required=""
                              separator=","
                              allowDuplicate={false}
                            ></Chips>
